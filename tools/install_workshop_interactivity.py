...
def main():
    ...
    scene['entities'].extend([
      ...
      control('workshop-rgb-red','Workshop RGB Red','rgb-red.png',185,407,18,78,251),control('workshop-rgb-green','Workshop RGB Green','rgb-green.png',213,407,18,78,251),control('workshop-rgb-blue','Workshop RGB Blue','rgb-blue.png',241,407,18,78,251),control('workshop-rgb-ok','Workshop RGB OK','rgb-ok.png',459,431,54,38,252)])
    scene['entities'] += [
